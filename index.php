            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <!-- Team Thumb-->
                        <div class="advisor_thumb"> <?php echo '<a href="Chandler_Farmer.php"><img src="grin smile.png" height="300" width="300" alt="">'?></a>
                            <!-- Social Info-->
                            <div class="social-info"> <?php echo '<a href="https://www.linkedin.com/in/chandlerfarmer"><i class="fa fa-linkedin"></i></a>'?></div>
                        </div>
                        <!-- Team Details-->
                        <div class="single_advisor_details_info">
                            <h6> <?php echo "Chandler Farmer"?></h6>
